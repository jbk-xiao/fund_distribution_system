...
function graph(level1, level2, level3, level4, level5, cur_center, zoom_val) {
...
export default {
    data() {
        return {
            ...
            level4: [],
            level5: [],
            cur_center: [78.114129, 12.550339],
    ...
    methods: {
        ...
        async getData() {
            ...
            // console.log(arr)
            setTimeout(() => {
                this.graph(this.level1, this.level2, this.level3, this.level4, this.level5, this.cur_center, 90);
                this.loading = false;
            }, 1000);
        ...
        async getData2() {
            ...
            // console.log(arr)
            setTimeout(() => {
                this.graph(this.level1, this.level2, this.level3, this.level4, this.level5, this.center);
                this.loading = false;
            }, 1000);
